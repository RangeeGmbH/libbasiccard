...
/* UTF-8 */
#if (defined(SIZE_MAX) || __STDC_VERSION__ >= 199901L || defined(WCHAR_MAX) || defined(_WCHAR_T) || defined(_WCHAR_T_DEFINED) || defined(_WCHAR_T_DECLARED) || defined(__cplusplus)) && !defined(LTC_NO_WCHAR)
#include <wchar.h>
#else
